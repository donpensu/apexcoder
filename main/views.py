...
from .models import AppInfo, Product
from .forms import *
from .models import *
...
def contact(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.info(request, 'please enter a valid information')
...
def profile_update(request):
    ...
    if request.method == 'POST':
        ...
        if profile.is_valid():
            ...
            messages.error(request, f'dear {new} your profile update gnerated the following errors: {profile.errors}')
...
def payment(request):
    if request.method == 'POST':
        ...
        api_key = 'sk_test_0c3aba5eae176adc71ee6dbd834770d2eb02b7a3' #secret key from paystack
        curl = 'https://api.paystack.co/transaction/initialize' #paystack call url
        cburl = 'http://16.171.136.25/callback' #callback or thank you page
